...
import { generateMnemonic, saveMnemonic } from '../../../../shared/crypto/keychain';
  ...
  return (
    <Wrapper>
      <View className="flex-col items-center">
        <View className=''>
          <Text className="text-2xl font-bold text-white text-center">Store your secret phrase</Text>
          <Text className="text-white text-xl text-center mt-2">This is your secret phares, make</Text>
          ...
          <View className="flex-1">
            <View className="flex-row justify-start gap-10 align-middle">
              ...
              <View className="flex-row">
                <Pressable onPress={() => copyToClipboard(mnemonic)} className="flex-row gap-1 items-center">
                  <Image
